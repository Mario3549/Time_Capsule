    ...
    <div className="min-h-screen theme-bg relative overflow-hidden pb-20" data-type-burst-root>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative">
        ...
        >
          ...
          <p className="theme-text-secondary text-lg">Capture your thoughts and memories for the future</p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              onChange={(e) => handleInputChange('title', e.target.value)}
                              placeholder="Give your Chronos capsule a meaningful title..."
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-white/50 dark:bg-white/5 rounded-lg">
                <div>
              ...
              {formData.hasPassword && (
                <div className="space-y-4 p-6 bg-white/20 dark:bg-white/5 rounded-lg border border-gray-200 dark:border-white/20">
                  <div className="space-y-3">
          ...
          <div className="pt-6">
            <button
              ...
              className="w-full bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center space-x-3 text-lg relative overflow-hidden"
            >
              {isSubmitting ? (
                <>
                ...
                <>
                  ...
                  <span>Create Chronos Capsule</span>
                </>
              )}
            </button>
          </div>
